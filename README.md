...
- PG Migration: prefer local migration tree and native manager-node migration APIs for more reliable applyMigration; Functions: `func.name` accepted as functionName fallback
