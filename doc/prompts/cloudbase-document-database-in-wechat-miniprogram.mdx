...
<AIDevelopmentPrompt ruleId="cloudbase-document-database-in-wechat-miniprogram" />
...
当前 Skill 在线查看： [cloudbase-document-database-in-wechat-miniprogram](https://skills.sh/tencentcloudbase/skills/cloudbase-document-database-in-wechat-miniprogram)
