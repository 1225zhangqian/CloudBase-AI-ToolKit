...
<AIDevelopmentPrompt ruleId="relational-database-web-cloudbase" />
...
当前 Skill 在线查看： [relational-database-web-cloudbase](https://skills.sh/tencentcloudbase/skills/relational-database-web-cloudbase)
