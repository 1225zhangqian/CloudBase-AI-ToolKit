...
<AIDevelopmentPrompt ruleId="relational-database-mcp-cloudbase" />
...
当前 Skill 在线查看： [relational-database-mcp-cloudbase](https://skills.sh/tencentcloudbase/skills/relational-database-mcp-cloudbase)
