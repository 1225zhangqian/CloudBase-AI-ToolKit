...
<AIDevelopmentPrompt ruleId="auth-wechat-miniprogram" />
...
当前 Skill 在线查看： [auth-wechat-miniprogram](https://skills.sh/tencentcloudbase/skills/auth-wechat-miniprogram)
