...
<AIDevelopmentPrompt ruleId="cloudbase-document-database-web-sdk" />
...
当前 Skill 在线查看： [cloudbase-document-database-web-sdk](https://skills.sh/tencentcloudbase/skills/cloudbase-document-database-web-sdk)
